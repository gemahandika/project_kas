...
mysqli_query($koneksi, "DELETE FROM tb_kantin WHERE id_kantin= '$_GET[id]'") or die(mysqli_error($koneksi));
showSweetAlert('success', 'Success', 'Data Berhasil di Hapus', '#dc3545', 'data_kantin.php');
